...
<template>
  <div
    v-if="userInfo.name"
    class="mx-auto shadow-lg w-full lg:container bg-white rounded-lg px-4 py-8 lg:p-10 flex flex-col space-y-10"
  >
    ...
    <div class="mb-8">
      <div
        class="flex flex-col space-y-8 md:flex-row md:space-x-10 items-center md:justify-start relative"
      >
    ...
    <div class="mb-8">
      ...
      <div class="bg-gray-50 p-4 rounded-lg">
        ...
        <p class="text-gray-700">
          Email: <span class="font-semibold">{{ userInfo.email }}</span>
        </p>
      </div>
    </div>
